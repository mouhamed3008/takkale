...
* @see app/Http/Controllers/Category/CategoryController.php:20
* @route '/categories'
*/
...
* @see app/Http/Controllers/Category/CategoryController.php:34
...
* @see app/Http/Controllers/Category/CategoryController.php:41
* @route '/categories'
*/
...
/**
* @see \App\Http\Controllers\Category\CategoryController::show
* @see app/Http/Controllers/Category/CategoryController.php:57
